...
spx1=matrix(c(strat1_ret,strat1_ret_g,strat1_ret_bb,z_score_ret,strat1_vola,strat1_vola_g,strat1_vola_bb,z_score_vola),ncol=6,nrow=8,byrow=FALSE)
...
spx2=matrix(c(strat2_ret,strat2_ret_g,strat2_ret_bb,z_score_ret,strat2_vola,strat2_vola_g,strat2_vola_bb,z_score_vola),ncol=6,nrow=8,byrow=FALSE)
...
ukx1=matrix(c(strat1_ret_uk,strat1_ret_g_uk,strat1_ret_bb_uk,z_score_ret_uk,strat1_vola_uk,strat1_vola_g_uk,strat1_vola_bb_uk,z_score_vola_uk),ncol=5,nrow=8,byrow=FALSE)
...
ukx2=matrix(c(strat2_ret_uk,strat2_ret_g_uk,strat2_ret_bb_uk,z_score_ret_uk,strat2_vola_uk,strat2_vola_g_uk,strat2_vola_bb_uk,z_score_vola_uk),ncol=5,nrow=8,byrow=FALSE)
...
#########################################################
fx1=matrix(c(strat1_ret_fx,strat1_ret_g_fx,strat1_ret_bb_fx,z_score_ret_fx,strat1_vola_fx,strat1_vola_g_fx,strat1_vola_bb_fx,z_score_vola_fx),ncol=6,nrow=8,byrow=FALSE)
...
fx2=matrix(c(strat2_ret_fx,strat2_ret_g_fx,strat2_ret_bb_fx,z_score_ret_fx,strat2_vola_fx,strat2_vola_g_fx,strat2_vola_bb_fx,z_score_vola_fx),ncol=6,nrow=8,byrow=FALSE)
